...
func (tu *TaskUpdate) SetDateCreated(t time.Time) *TaskUpdate {
	tu.mutation.SetDateCreated(t)
	return tu
}

// SetNillableDateCreated sets the "date_created" field if the given value is not nil.
func (tu *TaskUpdate) SetNillableDateCreated(t *time.Time) *TaskUpdate {
	if t != nil {
		tu.SetDateCreated(*t)
	}
	return tu
...
func (tu *TaskUpdate) SetDateUpdated(t time.Time) *TaskUpdate {
	tu.mutation.SetDateUpdated(t)
	return tu
}

// SetNillableDateUpdated sets the "date_updated" field if the given value is not nil.
func (tu *TaskUpdate) SetNillableDateUpdated(t *time.Time) *TaskUpdate {
	if t != nil {
		tu.SetDateUpdated(*t)
	}
	return tu
...
func (tu *TaskUpdate) SetUserID(id uuid.UUID) *TaskUpdate {
...
func (tu *TaskUpdate) check() error {
	if tu.mutation.UserCleared() && len(tu.mutation.UserIDs()) > 0 {
		return errors.New(`orm: clearing a required unique edge "Task.user"`)
	}
	return nil
}
...
// SetDateCreated sets the "date_created" field.
func (tuo *TaskUpdateOne) SetDateCreated(t time.Time) *TaskUpdateOne {
	tuo.mutation.SetDateCreated(t)
	return tuo
}

// SetNillableDateCreated sets the "date_created" field if the given value is not nil.
func (tuo *TaskUpdateOne) SetNillableDateCreated(t *time.Time) *TaskUpdateOne {
	if t != nil {
		tuo.SetDateCreated(*t)
	}
	return tuo
}

// SetDateUpdated sets the "date_updated" field.
func (tuo *TaskUpdateOne) SetDateUpdated(t time.Time) *TaskUpdateOne {
	tuo.mutation.SetDateUpdated(t)
	return tuo
}

// SetNillableDateUpdated sets the "date_updated" field if the given value is not nil.
func (tuo *TaskUpdateOne) SetNillableDateUpdated(t *time.Time) *TaskUpdateOne {
	if t != nil {
		tuo.SetDateUpdated(*t)
	}
	return tuo
}

// SetUserID sets the "user" edge to the User entity by ID.
func (tuo *TaskUpdateOne) SetUserID(id uuid.UUID) *TaskUpdateOne {
...
func (tuo *TaskUpdateOne) sqlSave(ctx context.Context) (_node *Task, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`orm: missing "Task.id" for update`)}
	}

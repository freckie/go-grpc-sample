...
func (uu *UserUpdate) SetDateUpdated(t time.Time) *UserUpdate {
	uu.mutation.SetDateUpdated(t)
	return uu
}

// SetNillableDateUpdated sets the "date_updated" field if the given value is not nil.
func (uu *UserUpdate) SetNillableDateUpdated(t *time.Time) *UserUpdate {
	if t != nil {
		uu.SetDateUpdated(*t)
	}
	return uu
...
// SetDateUpdated sets the "date_updated" field.
func (uuo *UserUpdateOne) SetDateUpdated(t time.Time) *UserUpdateOne {
	uuo.mutation.SetDateUpdated(t)
	return uuo
}

// SetNillableDateUpdated sets the "date_updated" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableDateUpdated(t *time.Time) *UserUpdateOne {
	if t != nil {
		uuo.SetDateUpdated(*t)
	}
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`orm: missing "User.id" for update`)}
	}
